...
--- | --- | ---
[connector_algolia](connector_algolia/) | 12.0.2.0.0 (unported) | Connector For Algolia Search Engine
[connector_elasticsearch](connector_elasticsearch/) | 12.0.0.1.0 (unported) | Connector For Elasticsearch Search Engine
[connector_search_engine](connector_search_engine/) | 12.0.2.0.1 (unported) | Connector Search Engine
